...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Feed', fields ['created']
        db.create_index(u'feedzilla_feed', ['created'])


    def backwards(self, orm):
        # Removing index on 'Feed', fields ['created']
        db.delete_index(u'feedzilla_feed', ['created'])
